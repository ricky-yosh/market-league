...
func (s *PortfolioService) GetPortfolioWithID(portfolioID uint) (*models.SanitizedPortfolio, error) {
	...
	dto := models.SanitizedPortfolio{
		...
		League:    models.SanitizedLeague{ID: portfolio.League.ID, LeagueName: portfolio.League.LeagueName, StartDate: portfolio.League.StartDate, EndDate: portfolio.League.EndDate, LeagueState: portfolio.League.LeagueState},
